...
<html>
    <head>
        ...
        @if($payment_type=='credit_card' || $payment_type == 'credit-card')
            <style>
    ...
    <script type="text/javascript" src="https://test-bankalfalah.gateway.mastercard.com/form/version/54/merchant/NIFT2/session.js"></script>
    ...
    <script type="text/javascript">
        ...
        document.addEventListener("DOMContentLoaded", function (event) {
            ...
            request = $.ajax({
                ...
                dataType: "json",
                data: JSON.stringify({
                    amount: {{$order->total_payable_pkr}},
                    source: "creditcard",
                    transaction_details: {
                        offer_id: {{$offer->id}}
                    },
                ...
                success: function(response) {
                    ...
                    let formGroups = document.getElementsByClassName("pgwhpccardfield");
                    ...
                    for (const formControl of formControls) {
                        if (formControl.getAttribute("type") == "button") {
                            ...
                            if(formControl.id == 'pgwhpcfld_CardExpiryMonth' || formControl.id == 'pgwhpcfld_CardExpiryYear') {
